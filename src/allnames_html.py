...
def main():
    ...
    # per-page
    NUM_TABLES = 1
    TITLE = "GKG Proper Names"
    entity_name = "proper names"
    HISTOGRAM_FILE1 = HISTOGRAM_DIR + "AllNamesHistogram.csv"
    TABLE1_TITLE = "V2.1ALLNAMES occurrences"
    OUTFILE = HTML_DIR + "allnames.html"
    #
