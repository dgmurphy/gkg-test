...
def main():
    ...
    # per-page
    NUM_TABLES = 1
    TITLE = "GKG Object Types in Counts"
    entity_name = "object types"
    HISTOGRAM_FILE1 = HISTOGRAM_DIR + "CountObjectsV2Histogram.csv"
    TABLE1_TITLE = "V2.1COUNTS (Object Type) occurrences"
    OUTFILE = HTML_DIR + "counts_objects.html"
    #
