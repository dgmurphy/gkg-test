...
def main():
    ...
    # per-page
    NUM_TABLES = 1
    TITLE = "GKG Words in Title"
    entity_name = "words"
    HISTOGRAM_FILE1 = HISTOGRAM_DIR + "TitleWordsHistogram.csv"
    TABLE1_TITLE = "Occurrences of Words in Title"
    OUTFILE = HTML_DIR + "wordsintitle.html"
    #
