...
def main():
    ...
    # per-page
    NUM_TABLES = 1
    TITLE = "GKG Amounts Objects"
    entity_name = "objects"
    HISTOGRAM_FILE1 = HISTOGRAM_DIR + "AmountObjectsHistogram.csv"
    TABLE1_TITLE = "Occurrences of Objects in Amounts field"
    OUTFILE = HTML_DIR + "amountsobjects.html"
    #
