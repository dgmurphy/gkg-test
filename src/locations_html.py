...
def main():
    ...
    TABLE1_TITLE = "V1LOCATIONS occurrences"

    HISTOGRAM_FILE2 = HISTOGRAM_DIR + "LocationsV2Histogram.csv"
    TABLE2_TITLE = "V2ENHANCEDLOCATIONS occurrences"
    ...
    t1caption = TABLE1_TITLE + f" ({len(hist_dict)} locations)"
    ...
    t2caption = TABLE2_TITLE + f" ({len(hist_dict)} locations)"
    html.append('  <div class="flexcol"> <table>')
