...
def main():
    ...
    NUM_TABLES = 2
    TITLE = "GKG Organizations"
    entity_name = "organizations"
    HISTOGRAM_FILE1 = HISTOGRAM_DIR + "OrgsHistogram.csv"
    TABLE1_TITLE = "V1ORGANIZATIONS occurrences"
    HISTOGRAM_FILE2 = HISTOGRAM_DIR + "OrgsV2Histogram.csv"
    TABLE2_TITLE = "V2ENHANCEDORGANIZATIONS occurrences"
    OUTFILE = HTML_DIR + "organizations.html"
