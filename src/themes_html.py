...
def main():
    ...
    TITLE = "GKG Themes"
    entity_name = "themes"
    HISTOGRAM_FILE1 = HISTOGRAM_DIR + "ThemesHistogram.csv"
    TABLE1_TITLE = "V1THEMES occurrences"
    HISTOGRAM_FILE2 = HISTOGRAM_DIR + "ThemesV2Histogram.csv"
    TABLE2_TITLE = "V2ENHANCEDTHEMES occurrences"
    OUTFILE = HTML_DIR + "themes.html"
    #
